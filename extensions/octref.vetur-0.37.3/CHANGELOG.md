...
- Ignore vue/multi-word-component-names in template validation. [#3649](https://github.com/vuejs/vetur/issues/3649)
- Fix vetur hang any request when project have .gitignore. [#3657](https://github.com/vuejs/vetur/issues/3657)
...
- Basic support `<script setup>`. [#2296](https://github.com/vuejs/vetur/issues/2296)
...
- Fix crash when typescript >= 4.8 and enable template type-checking. [#3520](https://github.com/vuejs/vetur/issues/3520)
...
- Fix template type-checking when typescript >= 4.5. [#3323](https://github.com/vuejs/vetur/issues/3323),#3424.
- Export all component for volar together.
- 🙌 Add support to interpolation service for index parameter with number iteration. Thanks to contribution from [@thebanjomatic](https://github.com/thebanjomatic). [#3222](https://github.com/vuejs/vetur/issues/3222)
