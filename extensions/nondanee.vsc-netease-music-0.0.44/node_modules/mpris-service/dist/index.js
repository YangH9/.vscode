...
Player.prototype.init = function (opts) {
  ...
  this._bus.requestName(this.serviceName, dbus.DBUS_NAME_FLAG_DO_NOT_QUEUE).then(exportInterfaces).catch(err => {
    if (err instanceof dbus.NameExistsError) {
      ...
      this._bus.requestName(this.serviceName).then(exportInterfaces).catch(emitError);
    } else {
      emitError(err);
    }
  });
