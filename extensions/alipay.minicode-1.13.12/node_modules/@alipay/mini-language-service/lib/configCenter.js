...
const mini_project_json_1 = require("@alipay/mini-extensions-shared/lib/node/configs/mini-project-json");
...
class MiniLanguageConfigCenter {
    ...
    readMiniProjectJson() {
        if (this.host.fileExists(this.miniProjectJsonPath)) {
            ...
            this.miniProjectJson = new mini_project_json_1.ProjectConfig(this.cwd, (0, mini_project_json_1.createMiniProjectJson)(data));
        }
        else {
    ...
    readAppJson() {
        if (this.host.fileExists(this.appJsonPath)) {
            try {
                ...
                this.logger.error('read app.json error: ' + error);
            }
        }
        else {
            this.appJson = {};
