...
import type { TLanguageId } from '@alipay/mini-extensions-shared/lib/i18n';
import type { EMessageKey } from './i18n';
...
export interface IMiniLanguageServiceContext {
    ...
    localize(key: EMessageKey, ...args: any[]): string;
    getLocale(): TLanguageId;
    updateLocale(locale: TLanguageId): void;
    dispose: () => void;
